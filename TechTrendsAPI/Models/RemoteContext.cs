...
namespace TechTrendsAPI.Models;

public partial class RemoteContext : DbContext
{
    public RemoteContext()
    {
    }

    public RemoteContext(DbContextOptions<RemoteContext> options)
        : base(options)
    {
    }
...
//    => optionsBuilder.UseSqlServer("Password=ilps@c.IL!42;Persist Security Info=True;User ID=cmpg323;Initial Catalog=remote;Data Source=zaazrcmpg323-server.database.windows.net");
